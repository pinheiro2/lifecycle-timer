...
import { type CompiledMapImports } from "./map-imports.js";
/**
 * Return a file path for the give file descriptor.
 */
export declare function generateFilePath(file: DescFile, bootstrapWkt: boolean, filesToGenerate: DescFile[], mapImports: CompiledMapImports): string;
/**
