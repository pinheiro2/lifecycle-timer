...
try {
  console.log('[lifecycle-timer] PRE-STEP: Installing sysstat and initializing monitor...');
  ...
  console.log(`[lifecycle-timer] Monitoring started early (PID: ${child.pid}) at ${startTime}`);
} catch (error) {
